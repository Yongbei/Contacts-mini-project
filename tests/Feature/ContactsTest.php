...
class ContactsTest extends TestCase
{
    ...
    /** @test */
    public function a_list_of_contacts_can_be_fetched_for_the_authentcated_user()
    {
    ...
    /** @test */
    public function only_the_owner_of_the_contact_can_patch_the_contant()
    {
        $contact = factory(Contact::class)->create(['user_id' => $this->user->id]);
    ...
    /** @test */
    public function only_the_owner_can_delete_the_contant()
    {
        $contact = factory(Contact::class)->create(['user_id' => $this->user->id]);
