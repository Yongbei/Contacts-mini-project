<template>
    <div>
        <!-- 反灰背景畫面 -->
        <div v-if="focus" @click="focus = !focus" class="bg-black opacity-25 absolute right-0 left-0 top-0 bottom-0 z-10">
        ...
        <div class="relative z-10">
            ...
            <input type="text" class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100" placeholder="Search..." id="searchTerm" v-model="searchTerm" @input="search" @focus="focus = !focus">
            ...
            <div v-if="focus" class="absolute bg-blue-900 text-white rounded-lg p-4 w-96 right-0 mr-6 mt-2 shadow z-20">
                ...
                <div v-for="result in results" :key="result" @click="focus = false">
